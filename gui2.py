...
while not done:
    ...
    buttonStartIdle = pygame.image.load('buttonIdle.png').convert()
    buttonStartHover = pygame.image.load('buttonHover.png').convert()
    buttonStartClick = pygame.image.load('buttonClick.png').convert()
